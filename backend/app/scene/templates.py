...
SCENE_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "beach_sunset": {
        ...
        "default_objects": [
            {"kind": "sun", "role": "background", "position": {"anchor": "custom", "x": 650, "y": 120, "layer": 1}, "size": {"preset": "large"}, "style": {"fill": "#F97316"}, "label": "太阳"},
            ...
            {"kind": "rect", "role": "foreground", "position": {"anchor": "custom", "x": 400, "y": 520, "layer": 3}, "size": {"preset": "wide", "width": 620, "height": 120}, "style": {"fill": "#F6C453", "stroke": "#F6C453"}, "label": "沙滩"},
            {"kind": "tree", "role": "foreground", "position": {"anchor": "custom", "x": 145, "y": 450, "layer": 4}, "size": {"preset": "large"}, "style": {"fill": "#16A34A"}, "label": "椰子树"},
            {"kind": "flower", "role": "foreground", "position": {"anchor": "custom", "x": 295, "y": 525, "layer": 5}, "size": {"preset": "tiny"}, "style": {"fill": "#FB7185"}, "label": "沙滩小花"},
        ],
    ...
    "park": {
        ...
        "default_objects": [
            ...
            {"kind": "tree", "role": "midground", "position": {"anchor": "custom", "x": 150, "y": 355, "layer": 2}, "size": {"preset": "large"}, "style": {"fill": "#22C55E"}, "label": "左边的树"},
            {"kind": "tree", "role": "midground", "position": {"anchor": "custom", "x": 650, "y": 350, "layer": 2}, "size": {"preset": "large"}, "style": {"fill": "#16A34A"}, "label": "右边的树"},
            {"kind": "swing", "role": "midground", "position": {"anchor": "custom", "x": 540, "y": 350, "layer": 3}, "size": {"preset": "medium"}, "style": {}, "label": "秋千"},
            ...
            {"kind": "bench", "role": "foreground", "position": {"anchor": "custom", "x": 405, "y": 425, "layer": 5}, "size": {"preset": "medium"}, "style": {}, "label": "长椅"},
            {"kind": "child", "role": "foreground", "position": {"anchor": "custom", "x": 265, "y": 440, "layer": 5}, "size": {"preset": "medium"}, "style": {}, "label": "小孩"},
            {"kind": "kite", "role": "decoration", "position": {"anchor": "custom", "x": 330, "y": 175, "layer": 5}, "size": {"preset": "small"}, "style": {}, "label": "风筝"},
            {"kind": "flower", "role": "foreground", "position": {"anchor": "custom", "x": 560, "y": 505, "layer": 6}, "size": {"preset": "tiny"}, "style": {"fill": "#A78BFA"}, "label": "花"},
        ],
    ...
    "birthday_card": {
        ...
        "default_objects": [
            ...
            {"kind": "confetti", "role": "decoration", "position": {"anchor": "custom", "x": 400, "y": 145, "layer": 1}, "size": {"preset": "large"}, "style": {}, "label": "彩带"},
            {"kind": "balloon", "role": "decoration", "position": {"anchor": "custom", "x": 215, "y": 235, "layer": 2}, "size": {"preset": "small"}, "style": {}, "label": "气球"},
            {"kind": "balloon", "role": "decoration", "position": {"anchor": "custom", "x": 585, "y": 235, "layer": 2}, "size": {"preset": "small"}, "style": {}, "label": "气球"},
            {"kind": "cake", "role": "foreground", "position": {"anchor": "custom", "x": 400, "y": 360, "layer": 3}, "size": {"preset": "medium"}, "style": {}, "label": "蛋糕"},
            {"kind": "gift", "role": "decoration", "position": {"anchor": "custom", "x": 255, "y": 420, "layer": 3}, "size": {"preset": "small"}, "style": {}, "label": "礼物"},
            {"kind": "gift", "role": "decoration", "position": {"anchor": "custom", "x": 545, "y": 420, "layer": 3}, "size": {"preset": "small"}, "style": {}, "label": "礼物"},
            {"kind": "text", "role": "label", "position": {"anchor": "custom", "x": 400, "y": 220, "layer": 4}, "size": {"preset": "wide", "height": 80}, "style": {"fill": "#BE123C", "text": "生日快乐"}, "label": "生日快乐"},
        ],
    ...
    "city_night": {
        ...
        "default_objects": [
            ...
            {"kind": "building", "role": "midground", "position": {"anchor": "custom", "x": 160, "y": 320, "layer": 2}, "size": {"preset": "large"}, "style": {"fill": "#334155"}, "label": "高楼"},
            {"kind": "building", "role": "midground", "position": {"anchor": "custom", "x": 340, "y": 295, "layer": 2}, "size": {"preset": "huge"}, "style": {"fill": "#1F2937"}, "label": "高楼"},
            {"kind": "building", "role": "midground", "position": {"anchor": "custom", "x": 540, "y": 315, "layer": 2}, "size": {"preset": "large"}, "style": {"fill": "#475569"}, "label": "高楼"},
            {"kind": "street_light", "role": "foreground", "position": {"anchor": "custom", "x": 690, "y": 420, "layer": 3}, "size": {"preset": "medium"}, "style": {}, "label": "路灯"},
            ...
            {"kind": "car", "role": "foreground", "position": {"anchor": "custom", "x": 520, "y": 520, "layer": 4}, "size": {"preset": "small"}, "style": {}, "label": "汽车"},
        ],
    ...
    "forest_house": {
        ...
        "default_objects": [
            ...
            {"kind": "tree", "role": "midground", "position": {"anchor": "custom", "x": 245, "y": 330, "layer": 2}, "size": {"preset": "large"}, "style": {"fill": "#166534"}, "label": "松树"},
            {"kind": "tree", "role": "midground", "position": {"anchor": "custom", "x": 650, "y": 345, "layer": 2}, "size": {"preset": "large"}, "style": {"fill": "#14532D"}, "label": "树"},
            {"kind": "house", "role": "midground", "position": {"anchor": "custom", "x": 420, "y": 345, "layer": 3}, "size": {"preset": "large"}, "style": {"fill": "#D9A066"}, "label": "小屋"},
            {"kind": "road", "role": "foreground", "position": {"anchor": "custom", "x": 410, "y": 515, "layer": 4}, "size": {"preset": "large", "width": 210, "height": 160}, "style": {"fill": "#A16207"}, "label": "小路"},
            {"kind": "flower", "role": "foreground", "position": {"anchor": "custom", "x": 145, "y": 510, "layer": 5}, "size": {"preset": "tiny"}, "style": {"fill": "#22C55E"}, "label": "草地"},
            {"kind": "flower", "role": "foreground", "position": {"anchor": "custom", "x": 650, "y": 510, "layer": 5}, "size": {"preset": "tiny"}, "style": {"fill": "#16A34A"}, "label": "草地"},
        ],
